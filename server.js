...
for (const page of ['board', 'deal', 'adders-report', 'dashboard', 'reps', 'rep-dashboard', 'payroll-staff', 'staff-dashboard', 'installers', 'settings', 'advances', 'clawbacks', 'referrals', 'pay-runs', 'pay-run']) {
