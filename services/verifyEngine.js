...
const CASES = [
  {
    ...
    deal: { contract_value: 57182.40, system_size_kw: 7.92, pay_split: 0.50, cashback_amount: 0, setter_rep_id: null },
    adders: [{ amount: 800, counts_as_hard_cost: true }, { amount: 13000, counts_as_hard_cost: true }, { amount: 3532.32, counts_as_hard_cost: true }],
    payScale: V1_SCALE,
    advance: 400,
    expect: { netPPW: 5.03, payScaleRate: 1100, closerNetPayable: 3956.00 }
  },
  {
    ...
    payScale: V1_SCALE,
    advance: 0,
    expect: { netPPW: 5.28, payScaleRate: 1200, closerNetPayable: 2952.00 }
  },
  {
    ...
    advance: 0,
    expect: { netPPW: 3.56, payScaleRate: 500, setterNetPayable: 358.75 }
  },
  {
    ...
    payScale: STANDARD_SCALE,
    advance: 0,
    expect: { netPPW: 4.14, payScaleRate: 725, setterNetPayable: 1108.89 }
  },
  {
    ...
    payScale: STANDARD_SCALE,
    advance: 0,
    expect: { netPPW: 3.87, payScaleRate: 675, setterNetPayable: 675.68 }
  },
  {
    ...
    payScale: STANDARD_SCALE,
    advance: 0,
    expect: { netPPW: 5.13, payScaleRate: 1000, closerNetPayable: 3520.00 },
...
for (const c of CASES) {
  const result = calculateRepCommission({
    ...
    payScale: c.payScale,
    settings: SETTINGS,
    advanceAlreadyTaken: c.advance || 0
  });
